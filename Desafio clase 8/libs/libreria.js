        ...
        try {
            ...
            if (index != -1){
                obj.id = this.list[index].id
                    ...
                    this.list[index].title = obj.title !== "" ? obj.title : this.list[index].title
                    this.list[index].author = obj.author !== "" ? obj.author : obj.author
                    this.list[index].pages = obj.pages !== "" ? obj.pages : obj.pages
                    this.list[index].thumbnail = obj.thumbnail !== "" ? obj.thumbnail : obj.thumbnail
